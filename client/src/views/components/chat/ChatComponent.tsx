...
import { useGetMessagesByChatIdQuery, useSendMessageMutation } from '@/features/messages/messagesSlice';
...
export const ChatComponent: React.FC<ChatComponentProps> = ({
  ...
  const { data: messages = [], isLoading, error } = useGetMessagesByChatIdQuery(chatId);
    ...
    <div className="flex flex-col h-96 bg-gray-50 dark:bg-gray-900 rounded-lg overflow-hidden">
      ...
      <div className="bg-white dark:bg-gray-800 border-b dark:border-gray-700 px-4 py-3 flex-shrink-0">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-white">{otherPartyName}</h3>
