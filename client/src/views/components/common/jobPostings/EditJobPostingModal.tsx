...
const EditJobPostingModal: React.FC<EditJobPostingModalProps> = ({
  ...
  const [updateJobPosting, { isLoading, isSuccess, isError }] = useUpdateJobPostingMutation();
  ...
  useEffect(() => {
    if (isError) toast.error("An error occurred while updating your job posting");
    if (isSuccess) {
            ...
            <div className="flex-1">
              ...
              {!areaError && area && (
                <div className="flex justify-end mt-1">
                  <Typography
                    variant="caption"
                    color={areaCharsLeft < 1 ? "error" : "green"}
                    className={
                      areaCharsLeft < 1
                        ? "text-red-500"
                        : "text-green-500 dark:text-green-400"
          ...
          <div className="w-full">
            ...
            {!contentError && (
              <div className="flex justify-end mt-1">
                <Typography
                  variant="caption"
                  color={contentCharsLeft < 1 ? "error" : "green"}
                  className={
                    contentCharsLeft < 1
                      ? "text-red-500"
                      : "text-green-500 dark:text-green-400"
