...
import { useUpvoteCommentMutation, useDownvoteCommentMutation } from '@/features/comments/commentsSlice';
...
const JobPostingCommentVoteButtons: React.FC<JobCommentVoteButtonsProps> = ({ comment }) => {
