...
const JobPostingCommentsSection: React.FC<JobCommentsSectionProps> = ({ jobPostingId }) => {
  ...
  return (
    <div className="dark:text-gray-200">
      ...
      {commentsLoading ? (
        ...
        <div className="p-4 rounded-md bg-gray-50 dark:bg-gray-700 text-center">
          <p className="text-gray-500 dark:text-gray-300">
            No comments yet. Be the first to share your thoughts about this job posting!
          </p>
        </div>
      )}
    </div>
