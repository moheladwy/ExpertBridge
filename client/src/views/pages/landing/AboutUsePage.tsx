        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
          <div className="text-center">
            ...
            <p className="mt-6 text-xl sm:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto transition-colors duration-200">
              Connecting expertise with opportunity through innovative
              technology
            </p>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg dark:shadow-gray-800/20 p-8 sm:p-12 transition-all duration-200">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-lg sm:text-xl text-gray-700 dark:text-gray-300 leading-relaxed text-center transition-colors duration-200">
              At ExpertBridge, we believe that every problem deserves the right
              expert, and every expert deserves the right opportunity. We're
              revolutionizing how professionals connect by creating a platform
              where expertise meets demand, fostering meaningful relationships
              that drive success for both service providers and clients.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg dark:shadow-gray-800/20 p-8 hover:shadow-xl dark:hover:shadow-gray-800/30 transition-all duration-200">
            ...
            <p className="text-gray-600 dark:text-gray-300 transition-colors duration-200">
              Connect with skilled professionals and technicians across various
              industries. Build meaningful relationships that drive your
              projects forward.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg dark:shadow-gray-800/20 p-8 hover:shadow-xl dark:hover:shadow-gray-800/30 transition-all duration-200">
            ...
            <p className="text-gray-600 dark:text-gray-300 transition-colors duration-200">
              Our AI-powered system matches job requirements with expert skills,
              ensuring the right professional for every task.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg dark:shadow-gray-800/20 p-8 hover:shadow-xl dark:hover:shadow-gray-800/30 transition-all duration-200">
            ...
            <p className="text-gray-600 dark:text-gray-300 transition-colors duration-200">
              Built-in chat system with AI-powered content moderation ensures
              safe, professional communication between all users.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg dark:shadow-gray-800/20 p-8 hover:shadow-xl dark:hover:shadow-gray-800/30 transition-all duration-200">
            ...
            <p className="text-gray-600 dark:text-gray-300 transition-colors duration-200">
              Our dual-role reputation system helps build trust by allowing both
              clients and professionals to rate each other.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg dark:shadow-gray-800/20 p-8 hover:shadow-xl dark:hover:shadow-gray-800/30 transition-all duration-200">
            ...
            <p className="text-gray-600 dark:text-gray-300 transition-colors duration-200">
              Stay updated with relevant opportunities and industry insights
              through our AI-curated personalized content feed.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg dark:shadow-gray-800/20 p-8 hover:shadow-xl dark:hover:shadow-gray-800/30 transition-all duration-200">
            ...
            <p className="text-gray-600 dark:text-gray-300 transition-colors duration-200">
              Leverage cutting-edge AI for content moderation, smart
              recommendations, and automated tagging to enhance your experience.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 transition-colors duration-200">
                ...
                reliability, and authentic connections.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 transition-colors duration-200">
                Empowering every user to achieve their highest potential through
                quality connections.
              </p>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-500 dark:to-indigo-500 rounded-2xl shadow-lg p-8 sm:p-12 transition-all duration-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <div className="text-blue-100 text-lg">Successful Projects</div>
            </div>
            <div className="text-center">
              <div className="text-4xl sm:text-5xl font-bold text-white mb-2">
                98%
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          ...
          <p className="mt-6 text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto transition-colors duration-200">
            ...
            problem-solvers dedicated to revolutionizing professional
            networking.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg dark:shadow-gray-800/20 p-8 text-center hover:shadow-xl dark:hover:shadow-gray-800/30 transition-all duration-200">
            ...
            <p className="text-gray-600 dark:text-gray-300 transition-colors duration-200">
              Building the future of professional connections with cutting-edge
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg dark:shadow-gray-800/20 p-8 text-center hover:shadow-xl dark:hover:shadow-gray-800/30 transition-all duration-200">
            ...
            <p className="text-gray-600 dark:text-gray-300 transition-colors duration-200">
              Developing intelligent systems that power smart matching, content
              moderation, and personalized experiences.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg dark:shadow-gray-800/20 p-8 text-center hover:shadow-xl dark:hover:shadow-gray-800/30 transition-all duration-200">
            ...
            <p className="text-gray-600 dark:text-gray-300 transition-colors duration-200">
              Creating intuitive, beautiful experiences that make professional
              networking effortless and enjoyable.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg dark:shadow-gray-800/20 p-8 sm:p-12 text-center transition-all duration-200">
          ...
          <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-8 transition-colors duration-200">
            ...
            careers and projects through ExpertBridge. Whether you're seeking
            expertise or offering your skills, we're here to connect you with
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 transition-colors duration-200">
            Have questions or want to learn more about ExpertBridge? We'd love
            to hear from you.
          </p>
