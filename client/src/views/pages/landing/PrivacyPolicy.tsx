const PrivacyPolicy = () => {
  return (
    <div className="bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 rounded-2xl shadow-lg max-w-4xl mx-auto p-6">
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-inside ml-4 text-gray-700 dark:text-gray-300">
          <li>
            Account Information: Name, email, phone number, location, password.
          </li>
          <li>
            Profile Data: Biography, profile picture, tags (skills), work
            history, education, certifications.
          </li>
          <li>
            Job Postings and Responses: Job descriptions, location, budget,
            answers, comments.
          </li>
          <li>
            Media Content: Photos, videos, documents uploaded with posts or in
            chat.
          </li>
          <li>
            Reviews & Ratings: Feedback you provide or receive after job
            completion.
          </li>
        </ul>
        <h3 className="text-xl font-medium mt-4 text-gray-800 dark:text-gray-200">
        ...
        <ul className="list-disc list-inside ml-4 text-gray-700 dark:text-gray-300">
          ...
          <li>
            Usage Data: Time spent, pages visited, features used, interaction
            logs.
          </li>
          <li>
            Cookies & Tracking Technologies: Session identifiers, preferences,
        ...
        <p className="text-gray-700 dark:text-gray-300">
          If you sign in or link your account with services like Google or
          Facebook, we may receive associated information (with your consent).
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-inside ml-4 text-gray-700 dark:text-gray-300">
          ...
          <li>
            Power AI-based features like content moderation, post
            recommendations, and tagging.
          </li>
          <li>
            Monitor user behavior for abuse prevention, fraud detection, and
            trust & safety.
          </li>
          <li>
            Notify you of messages, opportunities, changes to the platform, or
            legal updates.
          </li>
          <li>Personalize your feed and search results.</li>
          <li>
            Generate aggregated, anonymized analytics for product development.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="text-gray-700 dark:text-gray-300">
          Your profile, job posts, comments, ratings, and media may be visible
          to others as part of the Platform's functionality.
        </p>
        ...
        <p className="text-gray-700 dark:text-gray-300">
          Hosting providers, analytics tools, customer support, payment
          processors, and AI moderation services.
        </p>
        ...
        <p className="text-gray-700 dark:text-gray-300">
          To comply with applicable laws or protect the safety and rights of
          users or the public.
        </p>
        ...
        <p className="text-gray-700 dark:text-gray-300">
          If we undergo a merger, acquisition, or sale, your data may be part of
