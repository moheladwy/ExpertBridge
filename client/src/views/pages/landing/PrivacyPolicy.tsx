		...
		<div className="bg-card text-card-foreground mt-5 rounded-2xl shadow-lg max-w-4xl mx-auto p-6">
			...
			<section className="mb-6">
				...
				<p className="text-muted-foreground">
					...
					personal information when you use our platform, available
			...
			<section className="mb-6">
				...
				<ul className="list-disc list-inside ml-4 text-muted-foreground">
					...
					<li>
						Profile Data: Biography, profile picture, tags (skills),
						work history, education, certifications.
					</li>
					<li>
						Job Postings and Responses: Job descriptions, location,
						budget, answers, comments.
					</li>
					<li>
						Media Content: Photos, videos, documents uploaded with
						posts or in chat.
					</li>
					<li>
						Reviews & Ratings: Feedback you provide or receive after
						job completion.
					</li>
				</ul>
				<h3 className="text-xl font-medium mt-4 text-foreground">
				...
				<ul className="list-disc list-inside ml-4 text-muted-foreground">
					...
					<li>
						Usage Data: Time spent, pages visited, features used,
						interaction logs.
					</li>
					<li>
						Cookies & Tracking Technologies: Session identifiers,
			...
			<section className="mb-6">
				...
				<ul className="list-disc list-inside ml-4 text-muted-foreground">
					...
					<li>
						Monitor user behavior for abuse prevention, fraud
						detection, and trust & safety.
					</li>
					<li>
						Notify you of messages, opportunities, changes to the
						platform, or legal updates.
					</li>
					<li>Personalize your feed and search results.</li>
					<li>
						Generate aggregated, anonymized analytics for product
						development.
					</li>
				</ul>
			</section>
			...
			<section className="mb-6">
				...
				<p className="text-muted-foreground">
					...
					<strong>privacy@expertbridge.com</strong>.
				</p>
			</section>
