          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            <div className="flex flex-col items-start gap-6 text-white lg:text-center max-w-2xl">
              ...
              <p className="text-lg text-blue-100 leading-relaxed">
                The professional networking platform that connects you with the
                right expertise. Build your career, find solutions, and create
                meaningful professional relationships that drive success.
              </p>
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-6 text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              ExpertBridge is revolutionizing how professionals connect by
              creating a platform where expertise meets demand, fostering
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-gray-800/20 p-8 hover:shadow-xl transition-all duration-200">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Connect with skilled professionals and technicians across
                various industries. Build meaningful relationships that drive
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-gray-800/20 p-8 hover:shadow-xl transition-all duration-200">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Our AI-powered system matches job requirements with expert
                skills, ensuring the right professional for every task.
              </p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-gray-800/20 p-8 hover:shadow-xl transition-all duration-200">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Our dual-role reputation system helps build trust by allowing
                both clients and professionals to rate each other.
              </p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-gray-800/20 p-8 hover:shadow-xl transition-all duration-200">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                ...
                recommendations, and automated tagging to enhance your
                experience.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg dark:shadow-gray-800/20 p-8 sm:p-12 transition-all duration-200">
            ...
            <div className="max-w-4xl mx-auto">
              <p className="text-lg sm:text-xl text-gray-700 dark:text-gray-300 leading-relaxed text-center transition-colors duration-200">
                At ExpertBridge, we believe that every problem deserves the
                right expert, and every expert deserves the right opportunity.
                We're revolutionizing how professionals connect by creating a
                platform where expertise meets demand, fostering meaningful
                relationships that drive success for both service providers and
                clients.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl text-blue-100 mb-8">
              ...
              careers and projects through ExpertBridge.
            </p>
