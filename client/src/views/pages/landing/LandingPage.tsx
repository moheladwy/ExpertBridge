      ...
      <div className="max-lg:flex max-lg:justify-center max-lg:items-center h-screen bg-main-blue w-full ">
        <div className="flex justify-center items-center mx-28 gap-20 ">
          <div className="flex flex-col items-start gap-3 text-white max-w-xl">
            ...
            <p className="font-light">A professional networking platform that connects users with experts and technicians. Features include personalized feeds, job hiring, chat, AI-powered content moderation, and a dual-role reputation system. </p>
          </div>
      ...
      <div className='h-4/5 p-20'>
        <div className="flex max-lg:flex-col justify-center items-center mx-28 gap-20 max-md:gap-10 max-sm:gap-2 max-md:mx-2">
          <div className="flex flex-col items-start gap-3 text-main-blue max-w-xl">
            ...
            <p className="font-light max-md:text-sm">A professional networking platform that connects users with experts and technicians. Features include personalized feeds, job hiring, chat, AI-powered content moderation, and a dual-role reputation system. </p>
          </div>
