...
const JobDetailsPage: React.FC = () => {
  ...
  const handleConfirmAction = () => {
    ...
    toast.success(
      isWorker ? "Job completion confirmed!" : "Payment confirmation sent!",
    );
  };
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                💡 <strong>Tip:</strong> Both parties should confirm their
                respective actions - the worker confirms job completion and the
                hirer confirms payment received.
              </p>
            </div>
            <Button
              ...
              className={`px-6 py-3 ${
                (isWorker && job.isCompleted) || (!isWorker && job.isPaid)
