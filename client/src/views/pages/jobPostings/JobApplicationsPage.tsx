...
import { JobApplicationResponse, JobPosting } from "@/features/jobPostings/types";
import { JobApplicant } from "@/features/profiles/types";
import { useGetJobPostingQuery, useGetJobApplicationsQuery } from "@/features/jobPostings/jobPostingsSlice";
...
const JobApplicationsPage: React.FC = () => {
  ...
  const getCostDifference = (offeredCost: number, jobBudget: number) => {
    ...
    if (difference === 0) {
      return { text: "Exact match", color: "text-green-600", bgColor: "bg-green-100" };
            ...
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xl">{jobPosting.title}</span>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-1 text-gray-600 dark:text-gray-400">
                    ...
                    <span className="font-semibold">Budget: {formatBudget(jobPosting.budget)}</span>
                  </div>
                  <div className="flex items-center gap-1 text-gray-600 dark:text-gray-400">
                ...
                <Button
                  onClick={() => navigate(`/jobs/${jobPostingId}`)}
                  variant="outline"
                  size="sm"
                >
                  View Job Details
          ...
          <Card>
            <CardContent className="text-center py-12">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                ...
                Share it to attract more candidates!
              </p>
            </CardContent>
          </Card>
        ) : (
            ...
            {sortedApplications?.map((application) => {
              ...
              return (
                <Card
                  ...
                  className={`transition-all duration-200 hover:shadow-lg cursor-pointer ${selectedApplicant === application.applicantId
                ...
                >
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-4 mb-2">
                            ...
                            <div className="flex items-center gap-1 text-sm text-gray-600 dark:text-gray-400">
                              ...
                              <span>{applicant?.jobsDone} jobs completed</span>
                            </div>
                            <div className="flex items-center gap-1 text-sm text-gray-600 dark:text-gray-400">
                              <TrophyIcon className="h-4 w-4" />
                              <span>{applicant?.reputation} reputation</span>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center gap-2 text-sm text-gray-500">
                            ...
                            <span>Applied <TimeAgo timestamp={application.appliedAt} /></span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="text-right">
                        <div className="text-2xl font-bold text-gray-900 dark:text-white mb-1">
                          {formatBudget(application.offeredCost)}
                        </div>
                        <Badge
                          variant="secondary"
                    ...
                    {selectedApplicant === application.applicantId && application.coverLetter && (
