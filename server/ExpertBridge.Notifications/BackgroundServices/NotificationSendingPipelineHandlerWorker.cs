...
/// <summary>
///     Background service that continuously processes notification requests from the Channel queue, persists them to the
///     database, and broadcasts them via SignalR.
///     Implements the consumer side of the Channel-based notification pipeline initiated by
...
public class NotificationSendingPipelineHandlerWorker : BackgroundService
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="NotificationSendingPipelineHandlerWorker" /> class with the
    ///     notification channel and service provider.
    /// </summary>
    ...
    /// <summary>
    ///     Executes the notification processing loop, continuously reading from the channel, persisting to database, and
