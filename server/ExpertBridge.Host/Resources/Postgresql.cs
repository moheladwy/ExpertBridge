...
internal static class Postgresql
{
    ...
    /// <returns>A resource builder for the Postgres server resource, ready for deployment and integration within the application.</returns>
    public static IResourceBuilder<PostgresServerResource> GetPostgresqlResource(this IDistributedApplicationBuilder builder)
    {
