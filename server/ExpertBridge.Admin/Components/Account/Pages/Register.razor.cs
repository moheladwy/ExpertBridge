...
{
  [Inject]
  private UserManager<Database.Admin> UserManager { get; set; }

  [Inject]
  private IUserStore<Database.Admin> UserStore { get; set; }

  [Inject]
  private SignInManager<Database.Admin> SignInManager { get; set; }

  [Inject]
  private IEmailSender<Database.Admin> EmailSender { get; set; }
