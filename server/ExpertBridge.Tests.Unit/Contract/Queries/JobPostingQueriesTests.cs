...
public sealed class JobPostingQueriesTests
{
  ...
  public async Task FullyPopulatedJobPostingQuery_ShouldIncludeVotes()
  {
    ...
    var vote = TestDataBuilder.CreateJobPostingVote(jobPosting.Id, voter.Id, isUpvote: true);
  ...
  public async Task SelectJopPostingResponseFromFullJobPosting_ShouldCalculateUpvotesAndDownvotes()
  {
    ...
    var upvote1 = TestDataBuilder.CreateJobPostingVote(jobPosting.Id, voter1.Id, isUpvote: true);
    var upvote2 = TestDataBuilder.CreateJobPostingVote(jobPosting.Id, voter2.Id, isUpvote: true);
    var downvote = TestDataBuilder.CreateJobPostingVote(jobPosting.Id, voter3.Id, isUpvote: false);
  ...
  public async Task SelectJopPostingResponseFromFullJobPosting_ShouldSetIsUpvotedForCurrentUser()
  {
    ...
    var upvote = TestDataBuilder.CreateJobPostingVote(jobPosting.Id, currentUser.Id, isUpvote: true);
  ...
  public async Task SelectJopPostingResponseFromFullJobPosting_ShouldSetIsDownvotedForCurrentUser()
  {
    ...
    var downvote = TestDataBuilder.CreateJobPostingVote(jobPosting.Id, currentUser.Id, isUpvote: false);
