...
public sealed class JobQueriesTests : IDisposable
{
  ...
  {
    // Arrange
    var author = TestDataBuilder.CreateProfile(userId: "user1", firstName: "John", lastName: "Doe");
    var worker = TestDataBuilder.CreateProfile(userId: "user2", firstName: "Jane", lastName: "Smith");
  ...
  public async Task SelectJobResponseFromFullJob_ShouldProjectAuthorDetails()
  {
    ...
    var worker = TestDataBuilder.CreateProfile(userId: "user2", firstName: "Jane", lastName: "Smith");
    var job = TestDataBuilder.CreateJob(authorId: author.Id, workerId: worker.Id);
  ...
  {
    // Arrange
    var author = TestDataBuilder.CreateProfile(userId: "user1", firstName: "John");
    var worker1 = TestDataBuilder.CreateProfile(userId: "user2", firstName: "Jane");
    var worker2 = TestDataBuilder.CreateProfile(userId: "user3", firstName: "Bob");
  ...
  {
    // Arrange
    var author = TestDataBuilder.CreateProfile(userId: "user1", profilePictureUrl: null);
    var worker = TestDataBuilder.CreateProfile(userId: "user2", profilePictureUrl: null);
    var job = TestDataBuilder.CreateJob(authorId: author.Id, workerId: worker.Id);
