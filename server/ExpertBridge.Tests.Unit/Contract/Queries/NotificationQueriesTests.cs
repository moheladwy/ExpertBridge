...
public sealed class NotificationQueriesTests : IDisposable
{
    ...
    public async Task SelectNotificationResopnse_Should_UseUtcNow_When_CreatedAtIsNull()
    {
        ...
        {
            Id = "notif1", RecipientId = "user1", Message = "Test notification", CreatedAt = null // Explicitly null
        };
        _context.Set<Notification>().Add(notification);
        await _context.SaveChangesAsync();
    ...
    {
        // Arrange
        var notif1 = TestDataBuilder.CreateNotification("user1", "Notification 1", id: "n1");
        var notif2 = TestDataBuilder.CreateNotification("user1", "Notification 2", true, id: "n2");
        var notif3 = TestDataBuilder.CreateNotification("user2", "Notification 3", id: "n3");
    ...
    {
        // Arrange
        var notif1 = TestDataBuilder.CreateNotification("user1", "Unread 1");
        var notif2 = TestDataBuilder.CreateNotification("user1", "Read", true);
        var notif3 = TestDataBuilder.CreateNotification("user1", "Unread 2");
