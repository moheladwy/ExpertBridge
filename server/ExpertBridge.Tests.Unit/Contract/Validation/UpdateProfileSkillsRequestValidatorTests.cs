...
public sealed class UpdateProfileSkillsRequestValidatorTests
{
    ...
    {
        // Arrange
        var request = new UpdateProfileSkillsRequest { Skills = null! };
    ...
    {
        // Arrange
        var request = new UpdateProfileSkillsRequest { Skills = ["skill-id-1"] };
    ...
    {
        // Arrange
        var request = new UpdateProfileSkillsRequest { Skills = [] };
    ...
    public async Task Should_Pass_When_Skill_ID_Has_Max_Length()
    {
        ...
        var request = new UpdateProfileSkillsRequest { Skills = [maxLengthSkill] };
    ...
    public async Task Should_Pass_When_Skills_Has_Many_Items()
    {
        ...
        var request = new UpdateProfileSkillsRequest { Skills = skills };
    ...
    public async Task Should_Fail_When_Skill_Exceeds_Max_Length()
    {
        ...
        var request = new UpdateProfileSkillsRequest { Skills = [tooLongSkill] };
    ...
    {
        // Arrange
        var request = new UpdateProfileSkillsRequest { Skills = ["valid-skill-1", "", "valid-skill-2", null!] };
    ...
    {
        // Arrange
        var request = new UpdateProfileSkillsRequest { Skills = ["skill123", "123skill", "skill-123-test"] };
    ...
    {
        // Arrange
        var request = new UpdateProfileSkillsRequest { Skills = [skillId] };
