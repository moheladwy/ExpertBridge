...
public sealed class PostsCursorRequestValidatorTests
{
    ...
    {
        // Arrange
        var request = new PostsCursorRequest { PageSize = 10, Page = 1 };
    ...
    {
        // Arrange
        var request = new PostsCursorRequest { PageSize = 20, Page = 2, After = 0.75 };
    ...
    {
        // Arrange
        var request = new PostsCursorRequest { PageSize = 50, Page = 3, LastIdCursor = "post-id-12345" };
    ...
    {
        // Arrange
        var request = new PostsCursorRequest { PageSize = 25, Page = 1, After = 0.5, LastIdCursor = "post-abc" };
    ...
    {
        // Arrange
        var request = new PostsCursorRequest { PageSize = 10, Page = 1, After = 0 };
    ...
    {
        // Arrange
        var request = new PostsCursorRequest { PageSize = 10, Page = 1, After = 1 };
    ...
    {
        // Arrange
        var request = new PostsCursorRequest { PageSize = 1, Page = 1 };
    ...
    {
        // Arrange
        var request = new PostsCursorRequest { PageSize = 100, Page = 1 };
    ...
    public async Task Should_Pass_When_LastIdCursor_Has_Max_Length()
    {
        ...
        var request = new PostsCursorRequest { PageSize = 10, Page = 1, LastIdCursor = maxLengthCursor };
    ...
    {
        // Arrange
        var request = new PostsCursorRequest { PageSize = 0, Page = 1 };
    ...
    {
        // Arrange
        var request = new PostsCursorRequest { PageSize = 101, Page = 1 };
    ...
    {
        // Arrange
        var request = new PostsCursorRequest { PageSize = 10, Page = 0 };
    ...
    {
        // Arrange
        var request = new PostsCursorRequest { PageSize = 10, Page = 1, After = -0.1 };
    ...
    {
        // Arrange
        var request = new PostsCursorRequest { PageSize = 10, Page = 1, After = 1.1 };
    ...
    {
        // Arrange
        var request = new PostsCursorRequest { PageSize = 10, Page = 1, After = null };
    ...
    {
        // Arrange
        var request = new PostsCursorRequest { PageSize = 10, Page = 1, LastIdCursor = "" };
    ...
    public async Task Should_Fail_When_LastIdCursor_Exceeds_Max_Length()
    {
        ...
        var request = new PostsCursorRequest { PageSize = 10, Page = 1, LastIdCursor = tooLongCursor };
    ...
    {
        // Arrange
        var request = new PostsCursorRequest { PageSize = 10, Page = 1, LastIdCursor = null };
    ...
    {
        // Arrange
        var request = new PostsCursorRequest { PageSize = 0, Page = 0 };
    ...
    {
        // Arrange
        var request = new PostsCursorRequest { PageSize = 0, Page = -1, After = 2.0, LastIdCursor = "" };
    ...
    {
        // Arrange
        var request = new PostsCursorRequest { PageSize = pageSize, Page = 1 };
    ...
    {
        // Arrange
        var request = new PostsCursorRequest { PageSize = 10, Page = page };
    ...
    {
        // Arrange
        var request = new PostsCursorRequest { PageSize = 10, Page = 1, After = after };
