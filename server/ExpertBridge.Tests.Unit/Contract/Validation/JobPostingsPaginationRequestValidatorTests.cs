...
/// <summary>
///     Unit tests for JobPostingsPaginationRequestValidator using FluentValidation.TestHelper.
/// </summary>
/// <remarks>
///     Tests cover: PageSize (1-100), Page (>0), optional After (0-1), optional LastIdCursor validation.
/// </remarks>
public sealed class JobPostingsPaginationRequestValidatorTests
{
    private readonly JobPostingsPaginationRequestValidator _validator;

    public JobPostingsPaginationRequestValidatorTests()
    {
        _validator = new JobPostingsPaginationRequestValidator();
    }
    ...
    {
        // Arrange
        var request = new JobPostingsPaginationRequest { PageSize = 10, Page = 1 };
    ...
    {
        // Arrange
        var request = new JobPostingsPaginationRequest { PageSize = 20, Page = 2, After = 0.75 };
    ...
    {
        // Arrange
        var request = new JobPostingsPaginationRequest { PageSize = 50, Page = 3, LastIdCursor = "job-id-12345" };
    ...
    {
        // Arrange
        var request = new JobPostingsPaginationRequest
        {
            PageSize = 25, Page = 1, After = 0.5, LastIdCursor = "job-abc"
        };
    ...
    {
        // Arrange
        var request = new JobPostingsPaginationRequest { PageSize = 10, Page = 1, After = 0 };
    ...
    {
        // Arrange
        var request = new JobPostingsPaginationRequest { PageSize = 10, Page = 1, After = 1 };
    ...
    {
        // Arrange
        var request = new JobPostingsPaginationRequest { PageSize = 1, Page = 1 };
    ...
    {
        // Arrange
        var request = new JobPostingsPaginationRequest { PageSize = 100, Page = 1 };
    ...
    public async Task Should_Pass_When_LastIdCursor_Has_Max_Length()
    {
        ...
        var request = new JobPostingsPaginationRequest { PageSize = 10, Page = 1, LastIdCursor = maxLengthCursor };
    ...
    {
        // Arrange
        var request = new JobPostingsPaginationRequest { PageSize = 0, Page = 1 };
    ...
    {
        // Arrange
        var request = new JobPostingsPaginationRequest { PageSize = 101, Page = 1 };
    ...
    {
        // Arrange
        var request = new JobPostingsPaginationRequest { PageSize = 10, Page = 0 };
    ...
    {
        // Arrange
        var request = new JobPostingsPaginationRequest { PageSize = 10, Page = 1, After = -0.1 };
    ...
    {
        // Arrange
        var request = new JobPostingsPaginationRequest { PageSize = 10, Page = 1, After = 1.1 };
    ...
    {
        // Arrange
        var request = new JobPostingsPaginationRequest { PageSize = 10, Page = 1, After = null };
    ...
    {
        // Arrange
        var request = new JobPostingsPaginationRequest { PageSize = 10, Page = 1, LastIdCursor = "" };
    ...
    public async Task Should_Fail_When_LastIdCursor_Exceeds_Max_Length()
    {
        ...
        var request = new JobPostingsPaginationRequest { PageSize = 10, Page = 1, LastIdCursor = tooLongCursor };
    ...
    {
        // Arrange
        var request = new JobPostingsPaginationRequest { PageSize = 10, Page = 1, LastIdCursor = null };
    ...
    {
        // Arrange
        var request = new JobPostingsPaginationRequest { PageSize = 0, Page = 0 };
    ...
    {
        // Arrange
        var request = new JobPostingsPaginationRequest { PageSize = 0, Page = -1, After = 2.0, LastIdCursor = "" };
    ...
    {
        // Arrange
        var request = new JobPostingsPaginationRequest { PageSize = pageSize, Page = 1 };
    ...
    {
        // Arrange
        var request = new JobPostingsPaginationRequest { PageSize = 10, Page = page };
    ...
    {
        // Arrange
        var request = new JobPostingsPaginationRequest { PageSize = 10, Page = 1, After = after };
