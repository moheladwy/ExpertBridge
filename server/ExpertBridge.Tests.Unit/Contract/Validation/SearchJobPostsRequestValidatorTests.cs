...
public sealed class SearchJobPostsRequestValidatorTests
{
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "software developer" };
    ...
    public async Task Should_Pass_With_All_Fields_Valid()
    {
        ...
        {
            Query = "web developer", Limit = 50, MinBudget = 1000, MaxBudget = 5000
        };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "designer", MinBudget = 500 };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "designer", MaxBudget = 10000 };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "consultant", MinBudget = 5000, MaxBudget = 5000 };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "freelance", MinBudget = 0, MaxBudget = 1000 };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "enterprise", MinBudget = 999999, MaxBudget = 1000000 };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = null! };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = string.Empty };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "   " };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "developer", Limit = null };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "developer", Limit = 1 };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "developer", Limit = 100 };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "developer", Limit = 0 };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "developer", Limit = -10 };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "developer", Limit = 101 };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "developer", MinBudget = null };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "developer", MinBudget = 0 };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "developer", MinBudget = 1000000 };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "developer", MinBudget = -100 };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "developer", MinBudget = 1000001 };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "developer", MaxBudget = null };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "developer", MaxBudget = 0 };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "developer", MaxBudget = 1000000 };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "developer", MaxBudget = -500 };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "developer", MaxBudget = 1500000 };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "developer", MinBudget = 10000, MaxBudget = 5000 };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "developer", MinBudget = 5000, MaxBudget = null };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "developer", MinBudget = null, MaxBudget = 5000 };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "developer", MinBudget = null, MaxBudget = null };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "full-time remote senior developer" };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "C# .NET developer" };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "développeur français" };
    ...
    {
        // Arrange
        var request = new SearchJobPostsRequest { Query = "freelancer", MinBudget = 500.50m, MaxBudget = 1500.99m };
    ...
    public async Task Should_Pass_With_All_Optional_Fields_Null()
    {
        ...
        var request = new SearchJobPostsRequest
        {
            Query = "engineer", Limit = null, MinBudget = null, MaxBudget = null
        };
