...
public sealed class PatchCommentRequestValidatorTests
{
    ...
    public async Task Should_Not_Validate_Content_When_Null()
    {
        ...
        {
            CommentId = "comment123", Upvote = null, Downvote = null, Content = null
        };
    ...
    public async Task Should_Pass_With_Upvote_True()
    {
        ...
        var request = new PatchCommentRequest
        {
            CommentId = "comment123", Upvote = true, Downvote = null, Content = null
        };
    ...
    public async Task Should_Pass_With_Upvote_False()
    {
        ...
        var request = new PatchCommentRequest
        {
            CommentId = "comment123", Upvote = false, Downvote = null, Content = null
        };
    ...
    public async Task Should_Pass_With_Downvote_True()
    {
        ...
        var request = new PatchCommentRequest
        {
            CommentId = "comment123", Upvote = null, Downvote = true, Content = null
        };
    ...
    public async Task Should_Pass_With_Downvote_False()
    {
        ...
        var request = new PatchCommentRequest
        {
            CommentId = "comment123", Upvote = null, Downvote = false, Content = null
        };
    ...
    public async Task Should_Pass_With_Both_Voting_Flags()
    {
        ...
        var request = new PatchCommentRequest
        {
            CommentId = "comment123", Upvote = true, Downvote = true, Content = null
        };
    ...
    public async Task Should_Pass_With_Content_And_Voting()
    {
        ...
        var request = new PatchCommentRequest
        {
            CommentId = "comment123", Upvote = true, Downvote = false, Content = "Updated content with upvote."
        };
    ...
    {
        // Arrange
        var request = new PatchCommentRequest { CommentId = null!, Upvote = null, Downvote = null, Content = null };
    ...
    public async Task Should_Fail_When_CommentId_Is_Empty()
    {
        ...
        var request = new PatchCommentRequest
        {
            CommentId = string.Empty, Upvote = null, Downvote = null, Content = null
        };
    ...
    public async Task Should_Fail_When_Content_Is_Empty_String()
    {
        ...
        var request = new PatchCommentRequest
        {
            CommentId = "comment123", Upvote = null, Downvote = null, Content = string.Empty
        };
    ...
    public async Task Should_Fail_When_Content_Contains_Onload_Handler()
    {
        ...
        var request = new PatchCommentRequest
        {
            CommentId = "comment123", Upvote = null, Downvote = null, Content = "<img onload='alert(1)' src='x'>"
        };
    ...
    public async Task Should_Fail_With_Whitespace_Content()
    {
        ...
        var request = new PatchCommentRequest
        {
            CommentId = "comment123", Upvote = null, Downvote = null, Content = "   "
        };
    ...
    public async Task Should_Pass_With_Content_Containing_Unicode_Characters()
    {
        ...
        var request = new PatchCommentRequest
        {
            CommentId = "comment123", Upvote = null, Downvote = null, Content = "Unicode: 你好 Привет مرحبا 😀"
        };
    ...
    public async Task Should_Pass_With_GUID_CommentId()
    {
        ...
        var request = new PatchCommentRequest
        {
            CommentId = Guid.NewGuid().ToString(), Upvote = null, Downvote = null, Content = null
        };
