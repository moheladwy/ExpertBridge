...
public sealed class CreatePostRequestValidatorTests
{
    ...
    public async Task Should_Pass_When_Valid_With_Media()
    {
        ...
        var request = new CreatePostRequest
        {
            ...
            Media = new List<MediaObjectRequest> { new() { Type = "image/jpeg", Key = "valid-file-key.jpg" } }
        };
    ...
    {
        // Arrange
        var request = new CreatePostRequest { Title = "Valid Title", Content = "Valid content", Media = null };
    ...
    public async Task Should_Pass_When_Media_Is_Empty_List()
    {
        ...
        var request = new CreatePostRequest
        {
            Title = "Valid Title", Content = "Valid content", Media = new List<MediaObjectRequest>()
        };
    ...
    {
        // Arrange
        var request = new CreatePostRequest { Title = null!, Content = "Valid content" };
    ...
    {
        // Arrange
        var request = new CreatePostRequest { Title = string.Empty, Content = "Valid content" };
    ...
    public async Task Should_Have_Error_When_Title_Contains_Script_Tags()
    {
        ...
        var request = new CreatePostRequest
        {
            Title = "Bad Title <script>alert('xss')</script>", Content = "Valid content"
        };
    ...
    {
        // Arrange
        var request = new CreatePostRequest { Title = "Title with <b>HTML</b> tags", Content = "Valid content" };
    ...
    {
        // Arrange
        var request = new CreatePostRequest { Title = htmlTitle, Content = "Valid content" };
    ...
    {
        // Arrange
        var request = new CreatePostRequest { Title = "Valid Title", Content = null! };
    ...
    {
        // Arrange
        var request = new CreatePostRequest { Title = "Valid Title", Content = string.Empty };
    ...
    public async Task Should_Have_Error_When_Content_Exceeds_Max_Length()
    {
        ...
        var request = new CreatePostRequest
        {
            Title = "Valid Title", Content = new string('a', 5001) // Max is 5000
        };
    ...
    public async Task Should_Pass_When_Content_At_Max_Length()
    {
        ...
        var request = new CreatePostRequest
        {
            Title = "Valid Title", Content = new string('a', 5000) // Max length is 5000
        };
    ...
    public async Task Should_Have_Error_When_Content_Contains_Script_Tags()
    {
        ...
        var request = new CreatePostRequest
        {
            Title = "Valid Title", Content = "Content with <script>malicious code</script> embedded"
        };
    ...
    public async Task Should_Have_Error_When_Content_Contains_Dangerous_Patterns()
    {
        ...
        var request = new CreatePostRequest
        {
            Title = "Valid Title", Content = "Content with javascript:alert('xss') link"
        };
    ...
    {
        // Arrange
        var request = new CreatePostRequest { Title = "Valid Title", Content = dangerousContent };
    ...
    public async Task Should_Have_Error_When_Media_Count_Exceeds_10()
    {
        ...
        var request = new CreatePostRequest
        {
            ...
            Media = Enumerable.Range(1, 11)
                .Select(i => new MediaObjectRequest { Type = "image/jpeg", Key = $"file{i}.jpg" })
                .ToList()
        };
    ...
    public async Task Should_Pass_When_Media_Count_Is_10()
    {
        ...
        var request = new CreatePostRequest
        {
            ...
            Media = Enumerable.Range(1, 10)
                .Select(i => new MediaObjectRequest { Type = "image/jpeg", Key = $"valid-file-key-{i}.jpg" })
                .ToList()
        };
    ...
    public async Task Should_Have_Error_When_Media_Has_Invalid_Type()
    {
        ...
        var request = new CreatePostRequest
        {
            Title = "Valid Title",
            Content = "Valid content",
            Media = new List<MediaObjectRequest> { new() { Type = "application/exe", Key = "virus.exe" } }
        };
    ...
    public async Task Should_Have_Error_When_Media_Key_Contains_Path_Traversal()
    {
        ...
        var request = new CreatePostRequest
        {
            Title = "Valid Title",
            Content = "Valid content",
            Media = new List<MediaObjectRequest> { new() { Type = "image/jpeg", Key = "../../../etc/passwd" } }
        };
    ...
    public async Task Should_Have_Error_When_Media_Key_Has_Unsafe_Characters(string unsafeKey)
    {
        ...
        var request = new CreatePostRequest
        {
            Title = "Valid Title",
            Content = "Valid content",
            Media = new List<MediaObjectRequest> { new() { Type = "image/jpeg", Key = unsafeKey } }
        };
    ...
    {
        // Arrange
        var request = new CreatePostRequest { Title = "Valid Title", Content = "   " };
    ...
    public async Task Should_Detect_Script_Tags_With_Different_Casing()
    {
        ...
        var request = new CreatePostRequest
        {
            Title = "Title with <SCRIPT>alert('xss')</SCRIPT>", Content = "Valid content"
        };
    ...
    public async Task Should_Detect_Script_Tags_With_Attributes()
    {
        ...
        var request = new CreatePostRequest
        {
            Title = "Valid Title", Content = "Content with <script type='text/javascript'>alert('xss')</script>"
        };
