...
/// </summary>
/// <remarks>
///     Tests cover: optional JobTitle, Bio, FirstName, LastName, Username, PhoneNumber, Skills with XSS prevention and
...
public sealed class UpdateProfileRequestValidatorTests
{
    ...
    public async Task Should_Pass_With_Valid_JobTitle_And_Bio()
    {
        ...
        var request = new UpdateProfileRequest
        {
            ...
            Bio =
                "Passionate about AI and machine learning. Love solving complex problems with data-driven solutions."
        };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { FirstName = "Mary-Jane", LastName = "O'Connor" };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { Username = "user.name_123-test" };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { Skills = [] };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { JobTitle = null };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { JobTitle = string.Empty };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { JobTitle = "Software Engineer<script>alert('XSS')</script>" };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { JobTitle = "Click here: javascript:alert('XSS')" };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { JobTitle = "data:text/html,<script>alert('XSS')</script>" };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { JobTitle = "Engineer onclick=alert('XSS')" };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { Bio = null };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { Bio = string.Empty };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { Bio = new string('B', ProfileEntityConstraints.BioMaxLength + 1) };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { Bio = "I love coding <script>malicious()</script> and design." };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { Bio = "Visit my site: javascript:void(0)" };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { Bio = "Check this out: data:text/html,<h1>Test</h1>" };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { Bio = "My bio onload=alert('xss')" };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { FirstName = null };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { FirstName = string.Empty };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { FirstName = new string('F', UserEntityConstraints.MaxNameLength + 1) };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { FirstName = "John123" };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { FirstName = "John@Doe" };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { LastName = null };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { LastName = string.Empty };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { LastName = new string('L', UserEntityConstraints.MaxNameLength + 1) };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { LastName = "Doe123" };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { LastName = "Doe$%^" };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { Username = null };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { Username = string.Empty };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { Username = "user name" };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { PhoneNumber = null };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { PhoneNumber = string.Empty };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { PhoneNumber = "abc-def-ghij" };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { Skills = null! }; // Act
        var result = await _validator.TestValidateAsync(request);
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { Skills = ["skill-1", "skill-2", "skill-3"] };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { Skills = [null!] };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { Skills = [string.Empty] };
    ...
    public async Task Should_Fail_When_Skill_ID_Exceeds_MaxLength()
    {
        ...
        result.ShouldHaveValidationErrorFor(x => x.Skills)
            .WithErrorMessage(
                $"Each skill ID cannot be longer than {GlobalEntitiesConstraints.MaxIdLength} characters");
    }
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { JobTitle = jobTitle };
    ...
    {
        // Arrange
        var request = new UpdateProfileRequest { PhoneNumber = phoneNumber };
