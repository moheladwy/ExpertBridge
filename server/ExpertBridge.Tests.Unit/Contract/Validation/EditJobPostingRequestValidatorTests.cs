...
public sealed class EditJobPostingRequestValidatorTests
{
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Title = null, Content = null, Budget = null, Area = null };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Title = "Senior Full Stack Developer" };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Content = "We are looking for an experienced developer..." };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Budget = 50000m };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Area = "Software Development" };
    ...
    public async Task Should_Pass_With_All_Fields_Valid()
    {
        ...
        {
            Title = "Senior Developer", Content = "Detailed job description", Budget = 75000m, Area = "Technology"
        };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Budget = 0m };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Budget = 1000000m };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Title = new string('A', JobPostingEntityConstraints.MaxTitleLength) };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Area = new string('C', GlobalEntitiesConstraints.MaxIdLength) };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Title = string.Empty };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Title = "   " };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Title = titleWithScript };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Title = titleWithHtml };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Content = string.Empty };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Content = "   " };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Content = contentWithScript };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Content = contentWithJavascript };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Content = contentWithData };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Content = contentWithEvent };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Budget = -100m };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Budget = 1000001m };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Area = string.Empty };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Area = "   " };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Area = new string('X', GlobalEntitiesConstraints.MaxIdLength + 1) };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Title = null, Content = "Valid content", Budget = 1000m };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Title = "Valid title", Content = null, Budget = 1000m };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Title = "Valid title", Content = "Valid content", Budget = null };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Title = "Valid title", Area = null };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Content = "Job description with Unicode: 你好世界 🚀 Ω" };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Title = "Senior Developer 高级开发者 🔧" };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Content = "Content with <ScRiPt>alert('xss')</sCrIpT>" };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Title = "Job<ScRiPt>xss</ScRiPt>Title" };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Budget = 12345.67m };
    ...
    {
        // Arrange
        var request = new EditJobPostingRequest { Budget = 85000m };
