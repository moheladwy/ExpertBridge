...
public sealed class EditCommentRequestValidatorTests
{
    ...
    {
        // Arrange
        var request = new EditCommentRequest { Content = null };
    ...
    {
        // Arrange
        var request = new EditCommentRequest { Content = string.Empty };
    ...
    {
        // Arrange
        var request = new EditCommentRequest { Content = "   " };
    ...
    {
        // Arrange
        var request = new EditCommentRequest { Content = "Valid content but has <script>alert('xss')</script> in it" };
    ...
    {
        // Arrange
        var request = new EditCommentRequest { Content = "Click here: javascript:alert('xss')" };
    ...
    {
        // Arrange
        var request = new EditCommentRequest { Content = "Image: data:text/html,<script>alert('xss')</script>" };
    ...
    {
        // Arrange
        var request = new EditCommentRequest { Content = $"Content with {eventHandler} event handler" };
    ...
    {
        // Arrange
        var request = new EditCommentRequest { Content = "Content with <SCRIPT>alert('xss')</SCRIPT>" };
    ...
    {
        // Arrange
        var request = new EditCommentRequest { Content = "Link: JAVASCRIPT:alert('xss')" };
    ...
    {
        // Arrange
        var request = new EditCommentRequest { Content = "Content with &lt;safe&gt; HTML entities and &amp; symbols" };
    ...
    {
        // Arrange
        var request = new EditCommentRequest { Content = "Content with **bold** and *italic* markdown formatting" };
    ...
    {
        // Arrange
        var request = new EditCommentRequest { Content = "Check out https://example.com for more info" };
    ...
    {
        // Arrange
        var request = new EditCommentRequest { Content = "<script>alert('xss')</script> and javascript:void(0)" };
