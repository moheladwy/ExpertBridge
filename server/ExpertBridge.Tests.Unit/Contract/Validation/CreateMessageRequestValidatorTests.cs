...
public sealed class CreateMessageRequestValidatorTests
{
    ...
    {
        // Arrange
        var request = new CreateMessageRequest { ChatId = "chat-123", Content = "Hello, how are you?" };
    ...
    public async Task Should_Pass_With_ChatId_At_Max_Length()
    {
        ...
        {
            ChatId = new string('A', GlobalEntitiesConstraints.MaxIdLength), Content = "Test message"
        };
    ...
    public async Task Should_Pass_With_Content_At_Max_Length()
    {
        ...
        var request = new CreateMessageRequest
        {
            ChatId = "chat-456", Content = new string('B', GlobalEntitiesConstraints.MaxContentLetterLength)
        };
    ...
    {
        // Arrange
        var request = new CreateMessageRequest { ChatId = null!, Content = "Test message" };
    ...
    {
        // Arrange
        var request = new CreateMessageRequest { ChatId = string.Empty, Content = "Test message" };
    ...
    {
        // Arrange
        var request = new CreateMessageRequest { ChatId = "   ", Content = "Test message" };
    ...
    public async Task Should_Fail_When_ChatId_Exceeds_Max_Length()
    {
        ...
        var request = new CreateMessageRequest
        {
            ChatId = new string('X', GlobalEntitiesConstraints.MaxIdLength + 1), Content = "Test message"
        };
    ...
    {
        // Arrange
        var request = new CreateMessageRequest { ChatId = "chat-123", Content = null! };
    ...
    {
        // Arrange
        var request = new CreateMessageRequest { ChatId = "chat-123", Content = string.Empty };
    ...
    {
        // Arrange
        var request = new CreateMessageRequest { ChatId = "chat-123", Content = "   " };
    ...
    public async Task Should_Fail_When_Content_Exceeds_Max_Length()
    {
        ...
        var request = new CreateMessageRequest
        {
            ChatId = "chat-123", Content = new string('X', GlobalEntitiesConstraints.MaxContentLetterLength + 1)
        };
    ...
    {
        // Arrange
        var request = new CreateMessageRequest { ChatId = "chat-123", Content = contentWithScript };
    ...
    public async Task Should_Detect_Script_Tags_Case_Insensitively()
    {
        ...
        var request = new CreateMessageRequest
        {
            ChatId = "chat-123", Content = "Message with <ScRiPt>alert('xss')</sCrIpT>"
        };
    ...
    {
        // Arrange
        var request = new CreateMessageRequest { ChatId = "chat-123", Content = contentWithJavascript };
    ...
    {
        // Arrange
        var request = new CreateMessageRequest { ChatId = "chat-123", Content = contentWithData };
    ...
    {
        // Arrange
        var request = new CreateMessageRequest { ChatId = "chat-123", Content = contentWithEvent };
    ...
    {
        // Arrange
        var request = new CreateMessageRequest { ChatId = "chat-123", Content = "Hello 你好 🌟 مرحبا Привет" };
    ...
    {
        // Arrange
        var request = new CreateMessageRequest { ChatId = "chat-123", Content = "Great work! 👍 🎉 🚀" };
    ...
    public async Task Should_Pass_With_Special_Characters()
    {
        ...
        var request = new CreateMessageRequest
        {
            ChatId = "chat-123", Content = "Price: $100.50 | Discount: 20% | Rate: 4.5★"
        };
    ...
    {
        // Arrange
        var request = new CreateMessageRequest { ChatId = "chat-123", Content = "Line 1\nLine 2\nLine 3" };
    ...
    {
        // Arrange
        var request = new CreateMessageRequest { ChatId = "chat-123", Content = "5 &gt; 3 &amp; 2 &lt; 7" };
    ...
    {
        // Arrange
        var request = new CreateMessageRequest { ChatId = string.Empty, Content = "<script>alert('xss')</script>" };
    ...
    public async Task Should_Pass_With_URLs_In_Content()
    {
        ...
        var request = new CreateMessageRequest
        {
            ChatId = "chat-123", Content = "Check out this link: https://example.com"
        };
    ...
    {
        // Arrange
        var request = new CreateMessageRequest { ChatId = "chat-123", Content = "Contact me at user@example.com" };
    ...
    public async Task Should_Pass_With_Code_Snippets()
    {
        ...
        var request = new CreateMessageRequest
        {
            ChatId = "chat-123", Content = "Try this: var x = 10; console.log(x);"
        };
    ...
    public async Task Should_Pass_With_Quotes_In_Content()
    {
        ...
        var request = new CreateMessageRequest
        {
            ChatId = "chat-123", Content = "He said \"Hello\" and I replied 'Hi'"
        };
