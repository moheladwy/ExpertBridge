...
public sealed class ApplyToJobPostingRequestValidatorTests
{
    ...
    public async Task Should_Not_Validate_CoverLetter_When_Null()
    {
        ...
        var request = new ApplyToJobPostingRequest { JobPostingId = "job123", OfferedCost = 500m, CoverLetter = null };
    ...
    {
        // Arrange
        var request = new ApplyToJobPostingRequest { JobPostingId = "job123", OfferedCost = 0m, CoverLetter = null };
    ...
    public async Task Should_Pass_With_Decimal_OfferedCost()
    {
        ...
        var request = new ApplyToJobPostingRequest
        {
            JobPostingId = "job123", OfferedCost = 1234.56m, CoverLetter = null
        };
    ...
    {
        // Arrange
        var request = new ApplyToJobPostingRequest { JobPostingId = null!, OfferedCost = 500m, CoverLetter = null };
    ...
    public async Task Should_Fail_When_JobPostingId_Is_Empty()
    {
        ...
        var request = new ApplyToJobPostingRequest
        {
            JobPostingId = string.Empty, OfferedCost = 500m, CoverLetter = null
        };
    ...
    {
        // Arrange
        var request = new ApplyToJobPostingRequest { JobPostingId = "job123", OfferedCost = -1m, CoverLetter = null };
    ...
    public async Task Should_Fail_When_OfferedCost_Is_Very_Large()
    {
        ...
        var request = new ApplyToJobPostingRequest
        {
            JobPostingId = "job123", OfferedCost = 999999999m, CoverLetter = null
        };
    ...
    public async Task Should_Fail_When_CoverLetter_Contains_Script_Tag()
    {
        ...
        var request = new ApplyToJobPostingRequest
        {
            JobPostingId = "job123", OfferedCost = 500m, CoverLetter = "Hello <script>alert('xss')</script> world"
        };
    ...
    public async Task Should_Fail_When_CoverLetter_Contains_Javascript_Protocol()
    {
        ...
        var request = new ApplyToJobPostingRequest
        {
            JobPostingId = "job123", OfferedCost = 500m, CoverLetter = "Click here: javascript:alert('xss')"
        };
    ...
    public async Task Should_Fail_When_CoverLetter_Contains_Onclick_Handler()
    {
        ...
        var request = new ApplyToJobPostingRequest
        {
            JobPostingId = "job123", OfferedCost = 500m, CoverLetter = "<div onclick='alert(1)'>Click me</div>"
        };
    ...
    public async Task Should_Fail_When_CoverLetter_Contains_Onload_Handler()
    {
        ...
        var request = new ApplyToJobPostingRequest
        {
            JobPostingId = "job123", OfferedCost = 500m, CoverLetter = "<img onload='alert(1)' src='x'>"
        };
    ...
    public async Task Should_Fail_When_CoverLetter_Contains_Onerror_Handler()
    {
        ...
        var request = new ApplyToJobPostingRequest
        {
            JobPostingId = "job123", OfferedCost = 500m, CoverLetter = "<img onerror='alert(1)' src='invalid'>"
        };
    ...
    public async Task Should_Fail_When_CoverLetter_Contains_Onmouseover_Handler()
    {
        ...
        var request = new ApplyToJobPostingRequest
        {
            JobPostingId = "job123", OfferedCost = 500m, CoverLetter = "<div onmouseover='alert(1)'>Hover</div>"
        };
    ...
    public async Task Should_Pass_With_Empty_String_CoverLetter()
    {
        ...
        var request = new ApplyToJobPostingRequest
        {
            JobPostingId = "job123", OfferedCost = 500m, CoverLetter = string.Empty
        };
    ...
    {
        // Arrange
        var request = new ApplyToJobPostingRequest { JobPostingId = "job123", OfferedCost = 500m, CoverLetter = "   " };
    ...
    public async Task Should_Pass_With_CoverLetter_Containing_Special_Characters()
    {
        ...
        var request = new ApplyToJobPostingRequest
        {
            ...
            OfferedCost = 500m,
            CoverLetter =
                "I have 5+ years of experience! My skills include: C#, .NET, & SQL. Contact me at user@example.com."
        };
    ...
    public async Task Should_Pass_With_CoverLetter_Containing_Unicode_Characters()
    {
        ...
        var request = new ApplyToJobPostingRequest
        {
            JobPostingId = "job123", OfferedCost = 500m, CoverLetter = "Hello! 你好! Привет! مرحبا"
        };
    ...
    {
        // Arrange
        var request = new ApplyToJobPostingRequest { JobPostingId = "job123", OfferedCost = 0.01m, CoverLetter = null };
    ...
    public async Task Should_Pass_With_GUID_JobPostingId()
    {
        ...
        var request = new ApplyToJobPostingRequest
        {
            JobPostingId = Guid.NewGuid().ToString(), OfferedCost = 500m, CoverLetter = null
        };
