...
public sealed class CreateJobPostingRequestValidatorTests
{
    ...
    public async Task Should_Fail_When_Area_Is_Null()
    {
        ...
        var request = new CreateJobPostingRequest
        {
            Area = null!, Title = "Developer", Content = "Description", Budget = 1000m
        };
    ...
    public async Task Should_Fail_When_Area_Is_Empty()
    {
        ...
        var request = new CreateJobPostingRequest
        {
            Area = string.Empty, Title = "Developer", Content = "Description", Budget = 1000m
        };
    ...
    public async Task Should_Fail_When_Title_Is_Null()
    {
        ...
        var request = new CreateJobPostingRequest
        {
            Area = "IT", Title = null!, Content = "Description", Budget = 1000m
        };
    ...
    public async Task Should_Fail_When_Title_Is_Empty()
    {
        ...
        var request = new CreateJobPostingRequest
        {
            Area = "IT", Title = string.Empty, Content = "Description", Budget = 1000m
        };
    ...
    public async Task Should_Fail_When_Title_Contains_Script_Tags(string titleWithScript)
    {
        ...
        var request = new CreateJobPostingRequest
        {
            Area = "IT", Title = titleWithScript, Content = "Description", Budget = 1000m
        };
    ...
    public async Task Should_Fail_When_Title_Contains_HTML_Tags(string titleWithHtml)
    {
        ...
        var request = new CreateJobPostingRequest
        {
            Area = "IT", Title = titleWithHtml, Content = "Description", Budget = 1000m
        };
    ...
    {
        // Arrange
        var request = new CreateJobPostingRequest { Area = "IT", Title = "Developer", Content = null!, Budget = 1000m };
    ...
    public async Task Should_Fail_When_Content_Is_Empty()
    {
        ...
        var request = new CreateJobPostingRequest
        {
            Area = "IT", Title = "Developer", Content = string.Empty, Budget = 1000m
        };
    ...
    public async Task Should_Fail_When_Content_Contains_Script_Tags(string contentWithScript)
    {
        ...
        var request = new CreateJobPostingRequest
        {
            Area = "IT", Title = "Developer", Content = contentWithScript, Budget = 1000m
        };
    ...
    public async Task Should_Fail_When_Content_Contains_Javascript_Protocol(string contentWithJavascript)
    {
        ...
        var request = new CreateJobPostingRequest
        {
            Area = "IT", Title = "Developer", Content = contentWithJavascript, Budget = 1000m
        };
    ...
    public async Task Should_Fail_When_Content_Contains_Data_Protocol(string contentWithData)
    {
        ...
        var request = new CreateJobPostingRequest
        {
            Area = "IT", Title = "Developer", Content = contentWithData, Budget = 1000m
        };
    ...
    public async Task Should_Fail_When_Content_Contains_Event_Handlers(string contentWithEvent)
    {
        ...
        var request = new CreateJobPostingRequest
        {
            Area = "IT", Title = "Developer", Content = contentWithEvent, Budget = 1000m
        };
    ...
    public async Task Should_Fail_When_Budget_Is_Negative()
    {
        ...
        var request = new CreateJobPostingRequest
        {
            Area = "IT", Title = "Developer", Content = "Description", Budget = -100m
        };
    ...
    public async Task Should_Fail_When_Budget_Exceeds_Maximum()
    {
        ...
        var request = new CreateJobPostingRequest
        {
            Area = "IT", Title = "Developer", Content = "Description", Budget = 1000001m
        };
    ...
    public async Task Should_Pass_With_Budget_At_Minimum_Boundary()
    {
        ...
        var request = new CreateJobPostingRequest
        {
            Area = "IT", Title = "Developer", Content = "Description", Budget = 0m
        };
    ...
    public async Task Should_Pass_With_Budget_At_Maximum_Boundary()
    {
        ...
        var request = new CreateJobPostingRequest
        {
            Area = "IT", Title = "Developer", Content = "Description", Budget = 1000000m
        };
    ...
    public async Task Should_Fail_When_Title_Is_Whitespace()
    {
        ...
        var request = new CreateJobPostingRequest
        {
            Area = "IT", Title = "   ", Content = "Description", Budget = 1000m
        };
    ...
    {
        // Arrange
        var request = new CreateJobPostingRequest { Area = "IT", Title = "Developer", Content = "   ", Budget = 1000m };
    ...
    public async Task Should_Fail_When_Area_Is_Whitespace()
    {
        ...
        var request = new CreateJobPostingRequest
        {
            Area = "   ", Title = "Developer", Content = "Description", Budget = 1000m
        };
    ...
    public async Task Should_Pass_With_Unicode_Characters_In_Content()
    {
        ...
        var request = new CreateJobPostingRequest
        {
            Area = "IT", Title = "Developer", Content = "Job description with Unicode: 你好世界 🚀 Ω", Budget = 1000m
        };
    ...
    public async Task Should_Pass_With_Unicode_Characters_In_Title()
    {
        ...
        var request = new CreateJobPostingRequest
        {
            Area = "IT", Title = "Senior Developer 高级开发者 🔧", Content = "Description", Budget = 1000m
        };
    ...
    public async Task Should_Detect_Script_Tags_Case_Insensitively()
    {
        ...
        var request = new CreateJobPostingRequest
        {
            Area = "IT", Title = "Developer", Content = "Content with <ScRiPt>alert('xss')</sCrIpT>", Budget = 1000m
        };
    ...
    public async Task Should_Pass_With_Decimal_Budget_Values()
    {
        ...
        var request = new CreateJobPostingRequest
        {
            Area = "IT", Title = "Developer", Content = "Description", Budget = 12345.67m
        };
