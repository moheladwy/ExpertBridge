...
/// It provides a clean, semantic API for common user operations while delegating the actual work to AuthorizationHelper.
/// 
...
public class UserService
{
    ...
    /// <summary>
    /// Retrieves the Profile of the currently authenticated user, throwing an exception if not authenticated or profile not found.
    /// </summary>
    /// <returns>
