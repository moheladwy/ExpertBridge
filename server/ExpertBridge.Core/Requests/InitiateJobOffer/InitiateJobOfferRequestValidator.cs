...
public class InitiateJobOfferRequestValidator : AbstractValidator<InitiateJobOfferRequest>
{
  ...
  public InitiateJobOfferRequestValidator()
  {
    RuleFor(x => x.ContractorProfileId)
        ...
        .WithMessage($"ContractorProfileId cannot be longer than {GlobalEntitiesConstraints.MaxIdLength} characters");
    ...
    RuleFor(x => x.Description)
        ...
        .WithMessage($"Description cannot be longer than {GlobalEntitiesConstraints.MaxDescriptionLength} characters");
