...
///     Defines the database schema for job offers including primary key, description constraints, relationships with
///     worker and author profiles, and associated job application references.
/// </summary>
public class JobOfferEntityConfiguration : IEntityTypeConfiguration<JobOffer>
{
    /// <summary>
    ///     Configures the entity type for JobOffer, including primary key, worker index for query optimization, description
    ///     max length constraint, and relationships with Profile entities (as worker and author).
    /// </summary>
