...
///     They support AI-powered features including automatic tagging, content moderation, semantic search through vector
///     embeddings,
...
public sealed class Post : BaseModel, ISoftDeletable, IRecommendableContent, ISafeContent
{
    ...
    /// </summary>
    /// <remarks>
    ///     This is distinct from <see cref="BaseModel.LastModified" /> which is automatically set by the system for any
    ///     changes.
    /// </remarks>
