...
/// </summary>
/// <remarks>
/// Moderation reports are generated through AI-powered content analysis that detects various types of inappropriate content
/// including toxicity, obscenity, threats, insults, identity attacks, and sexual content. Reports can be manually reviewed
...
public class ModerationReport : BaseModel, ISoftDeletable
{
    ...
    /// </summary>
    /// <remarks>
    /// Higher values indicate very hateful, aggressive, or disrespectful content that is very likely to make users leave a discussion.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// Higher values indicate negative or hateful content targeting someone's identity including race, religion, gender, disability, etc.
    /// </remarks>
