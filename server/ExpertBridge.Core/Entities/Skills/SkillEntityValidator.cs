...
public class SkillEntityValidator : AbstractValidator<Skill>
{
    ...
    public SkillEntityValidator()
    {
        ...
        RuleFor(x => x.Name)
            ...
            .MaximumLength(SkillEntityConstraints.MaxNameLength)
            .WithMessage($"Name must be less than {SkillEntityConstraints.MaxNameLength} characters");

        RuleFor(x => x.Description)
            .NotNull().WithMessage("Description is required")
            .NotEmpty().WithMessage("Description is required")
            .MaximumLength(SkillEntityConstraints.MaxDescriptionLength).WithMessage(
                $"Description must be less than {SkillEntityConstraints.MaxDescriptionLength} characters");
    }
}
