...
namespace ExpertBridge.Api.Application.Repositories.Comment;

public class CommentRepository(ExpertBridgeDbContext db) : IEntityRepository<Core.Entities.Comment.Comment>
{
