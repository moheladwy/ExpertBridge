...
///     a web application.
///     Specifically, it adds the <see cref="GroqApiChatCompletionClient" /> and <see cref="GroqLlmTextTextProvider" />
///     services to the ASP.NET Core
///     service collection.
/// </remarks>
/// <seealso cref="GroqApiChatCompletionClient" />
/// <seealso cref="GroqLlmTextTextProvider" />
public static class GroqApi
{
    ...
    ///     <see cref="GroqLlmTextTextProvider" /> services into the application's service collection.
        ...
        this WebApplicationBuilder builder)
    {
        ...
        builder.Services
            ...
            .AddScoped<GroqLlmTextTextProvider>()
