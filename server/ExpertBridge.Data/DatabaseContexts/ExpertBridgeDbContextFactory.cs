...
/// <summary>
/// Provides a factory for creating instances of <see cref="ExpertBridgeDbContext"/> at design time for Entity Framework Core tooling.
/// Used by EF Core migration commands (dotnet ef migrations add, dotnet ef database update) to create a database context without running the application.
/// </summary>
/// <remarks>
