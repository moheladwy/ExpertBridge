...
/// Provides access to all entity sets (DbSets) and configures automatic timestamp updates, soft delete query filters, and entity configurations.
/// Supports PostgreSQL with pgvector extension for semantic search capabilities using 1024-dimensional vector embeddings.
/// </summary>
/// <remarks>
...
public sealed class ExpertBridgeDbContext : DbContext
{
    ...
    /// <summary>
    /// Gets or sets the DbSet for Profile entities representing professional profiles with vector embeddings for personalized recommendations.
    /// </summary>
    public DbSet<Profile> Profiles { get; set; }

    /// <summary>
    /// Gets or sets the DbSet for ProfileExperience entities representing work experience, certifications, and education entries on professional profiles.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the DbSet for Tag entities representing AI-generated multilingual content tags used for categorization and discovery.
    /// </summary>
    public DbSet<Tag> Tags { get; set; }

    /// <summary>
    /// Gets or sets the DbSet for Job entities representing completed freelance work contracts between experts and clients.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the DbSet for Post entities representing social posts with AI-powered tagging and semantic search capabilities.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the DbSet for JobPosting entities representing freelance job opportunities with AI-powered semantic matching using pgvector.
    /// </summary>
    public DbSet<JobPosting> JobPostings { get; set; }

    /// <summary>
    /// Gets or sets the DbSet for JobPostingTag entities representing the many-to-many relationship between job postings and tags.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the DbSet for JobCategory entities representing hierarchical categorization of job types and industries.
    /// </summary>
    public DbSet<JobCategory> JobCategories { get; set; }

    /// <summary>
    /// Gets or sets the DbSet for JobApplication entities representing expert applications to job postings with proposal details.
    /// </summary>
    public DbSet<JobApplication> JobApplications { get; set; }

    /// <summary>
    /// Gets or sets the DbSet for ProfileBadge entities representing the many-to-many relationship between profiles and earned badges.
    /// </summary>
    public DbSet<ProfileBadge> ProfileBadges { get; set; }

    /// <summary>
    /// Gets or sets the DbSet for UserInterest entities representing the many-to-many relationship between users and their topic interests for personalized content recommendations.
    /// </summary>
    public DbSet<UserInterest> UserInterests { get; set; }

    /// <summary>
    /// Gets or sets the DbSet for ProfileSkill entities representing the many-to-many relationship between profiles and their professional skills.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the DbSet for ChatParticipant entities representing the many-to-many relationship between chats and participating profiles.
    /// </summary>
    public DbSet<ChatParticipant> ChatParticipants { get; set; }

    /// <summary>
    /// Gets or sets the DbSet for PostTag entities representing the many-to-many relationship between posts and AI-generated tags.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the DbSet for ProfileMedia entities representing media files associated with professional profiles (profile pictures, cover photos, portfolio items).
    /// </summary>
    public DbSet<ProfileMedia> ProfileMedias { get; set; }

    /// <summary>
    /// Gets or sets the DbSet for ProfileExperienceMedia entities representing work samples, certifications, and evidence files for profile experience entries.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the DbSet for JobPostingMedia entities representing project examples, requirements, and reference files for job postings.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the DbSet for MediaGrant entities representing temporary access grants for AWS S3 presigned URL generation and media upload authorization.
    /// </summary>
    public DbSet<MediaGrant> MediaGrants { get; set; }

    /// <summary>
    /// Gets or sets the DbSet for ModerationReport entities representing content moderation reports with AI-assisted review using Groq API.
    /// </summary>
    public DbSet<ModerationReport> ModerationReports { get; set; }

    /// <summary>
    /// Gets or sets the DbSet for Notification entities representing real-time notifications delivered via SignalR to platform users.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the DbSet for Message entities representing individual messages within chat conversations with real-time delivery via SignalR.
    /// </summary>
    ...
    /// Applies entity configurations, enables PostgreSQL vector extension, and sets up global query filters for soft-deleted entities.
    /// </summary>
    ...
    /// <summary>
    /// Event handler that automatically updates timestamp properties on entities implementing <see cref="ITimestamped"/> interface.
