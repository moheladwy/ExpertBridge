...
ALTER INDEX "IX_Users_FirebaseId" RENAME TO "IX_Users_ProviderId";

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20250222144618_UpdateFirebaseIdProbNameToProviderId', '9.0.2');

ALTER TABLE "Profiles" ALTER COLUMN "JobTitle" DROP NOT NULL;
...
ALTER INDEX "IX_Comments_ParentId" RENAME TO "IX_Comments_ParentCommentId";

UPDATE "Comments" SET "PostId" = '' WHERE "PostId" IS NULL;
ALTER TABLE "Comments" ALTER COLUMN "PostId" SET NOT NULL;
ALTER TABLE "Comments" ALTER COLUMN "PostId" SET DEFAULT '';

ALTER TABLE "Comments" ADD CONSTRAINT "FK_Comments_Comments_ParentCommentId" FOREIGN KEY ("ParentCommentId") REFERENCES "Comments" ("Id") ON DELETE CASCADE;
...
ALTER TABLE "Posts" ADD "IsProcessed" boolean NOT NULL DEFAULT FALSE;

ALTER TABLE "Posts" ADD "IsTagged" boolean NOT NULL DEFAULT FALSE;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20250321193023_RenameSomeFields', '9.0.2');

ALTER TABLE "Profiles" ADD "CreatedAt" timestamp with time zone NOT NULL DEFAULT TIMESTAMPTZ '-infinity';

ALTER TABLE "Profiles" ADD "Email" text NOT NULL DEFAULT '';

ALTER TABLE "Profiles" ADD "FirstName" text NOT NULL DEFAULT '';

ALTER TABLE "Profiles" ADD "IsBanned" boolean NOT NULL DEFAULT FALSE;

ALTER TABLE "Profiles" ADD "IsDeleted" boolean NOT NULL DEFAULT FALSE;

ALTER TABLE "Profiles" ADD "LastName" text;

ALTER TABLE "Profiles" ADD "PhoneNumber" text;

ALTER TABLE "Profiles" ADD "Username" text NOT NULL DEFAULT '';

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20250321220207_AddUserInfoToProfileEntity', '9.0.2');

ALTER TABLE "Users" ADD "LastModified" timestamp with time zone;

ALTER TABLE "Profiles" ALTER COLUMN "Username" DROP NOT NULL;

ALTER TABLE "Profiles" ALTER COLUMN "FirstName" DROP NOT NULL;

ALTER TABLE "Profiles" ADD "LastModified" timestamp with time zone;
...
ALTER TABLE "CommentVotes" ADD "LastModified" timestamp with time zone;
...
ALTER INDEX "IX_Media_MediaUrl" RENAME TO "IX_MediaObject_Url";

ALTER INDEX "IX_Media_MediaTypeId" RENAME TO "IX_MediaObject_MediaTypeId";

ALTER TABLE "MediaObject" ALTER COLUMN "MediaTypeId" DROP NOT NULL;

ALTER TABLE "MediaObject" ADD "ChatId" character varying(450);

ALTER TABLE "MediaObject" ADD "CommentId" character varying(450);

ALTER TABLE "MediaObject" ADD "Discriminator" character varying(34) NOT NULL DEFAULT '';

ALTER TABLE "MediaObject" ADD "JobPostingId" character varying(450);

ALTER TABLE "MediaObject" ADD "Key" text NOT NULL DEFAULT '';

ALTER TABLE "MediaObject" ADD "PostId" character varying(450);

ALTER TABLE "MediaObject" ADD "ProfileExperienceId" character varying(450);

ALTER TABLE "MediaObject" ADD "ProfileId" character varying(450);

ALTER TABLE "MediaObject" ADD "Type" text NOT NULL DEFAULT '';

ALTER TABLE "MediaObject" ADD CONSTRAINT "PK_MediaObject" PRIMARY KEY ("Id");
...
ALTER TABLE "MediaObject" ADD CONSTRAINT "FK_MediaObject_Chats_ChatId" FOREIGN KEY ("ChatId") REFERENCES "Chats" ("Id") ON DELETE CASCADE;

ALTER TABLE "MediaObject" ADD CONSTRAINT "FK_MediaObject_Comments_CommentId" FOREIGN KEY ("CommentId") REFERENCES "Comments" ("Id") ON DELETE CASCADE;

ALTER TABLE "MediaObject" ADD CONSTRAINT "FK_MediaObject_JobPostings_JobPostingId" FOREIGN KEY ("JobPostingId") REFERENCES "JobPostings" ("Id") ON DELETE CASCADE;

ALTER TABLE "MediaObject" ADD CONSTRAINT "FK_MediaObject_MediaTypes_MediaTypeId" FOREIGN KEY ("MediaTypeId") REFERENCES "MediaTypes" ("Id");

ALTER TABLE "MediaObject" ADD CONSTRAINT "FK_MediaObject_Posts_PostId" FOREIGN KEY ("PostId") REFERENCES "Posts" ("Id") ON DELETE CASCADE;

ALTER TABLE "MediaObject" ADD CONSTRAINT "FK_MediaObject_ProfileExperiences_ProfileExperienceId" FOREIGN KEY ("ProfileExperienceId") REFERENCES "ProfileExperiences" ("Id") ON DELETE CASCADE;

ALTER TABLE "MediaObject" ADD CONSTRAINT "FK_MediaObject_Profiles_ProfileId" FOREIGN KEY ("ProfileId") REFERENCES "Profiles" ("Id") ON DELETE CASCADE;
...
ALTER INDEX "IX_MediaObject_ProfileId" RENAME TO "IX_ProfileMedias_ProfileId";

UPDATE "ProfileMedias" SET "ProfileId" = '' WHERE "ProfileId" IS NULL;
ALTER TABLE "ProfileMedias" ALTER COLUMN "ProfileId" SET NOT NULL;
ALTER TABLE "ProfileMedias" ALTER COLUMN "ProfileId" SET DEFAULT '';

ALTER TABLE "ProfileMedias" ADD "DeletedAt" timestamp with time zone;

ALTER TABLE "ProfileMedias" ADD "IsDeleted" boolean NOT NULL DEFAULT FALSE;

ALTER TABLE "ProfileMedias" ADD CONSTRAINT "PK_ProfileMedias" PRIMARY KEY ("Id");
...
ALTER TABLE "ProfileMedias" ADD CONSTRAINT "FK_ProfileMedias_Profiles_ProfileId" FOREIGN KEY ("ProfileId") REFERENCES "Profiles" ("Id") ON DELETE CASCADE;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20250425174728_FixNotDeletedIndexFilter', '9.0.2');

ALTER TABLE "ProfileExperiences" ADD "CreatedAt" timestamp with time zone NOT NULL DEFAULT TIMESTAMPTZ '-infinity';

ALTER TABLE "ProfileExperiences" ADD "DeletedAt" timestamp with time zone;

ALTER TABLE "ProfileExperiences" ADD "IsDeleted" boolean NOT NULL DEFAULT FALSE;

ALTER TABLE "ProfileExperiences" ADD "LastModified" timestamp with time zone;

ALTER TABLE "JobPostings" ADD "DeletedAt" timestamp with time zone;

ALTER TABLE "JobPostings" ADD "IsDeleted" boolean NOT NULL DEFAULT FALSE;

ALTER TABLE "JobPostings" ADD "LastModified" timestamp with time zone;

ALTER TABLE "Chats" ADD "DeletedAt" timestamp with time zone;

ALTER TABLE "Chats" ADD "IsDeleted" boolean NOT NULL DEFAULT FALSE;

ALTER TABLE "Chats" ADD "LastModified" timestamp with time zone;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20250425230547_AddBaseModelToOtherEntities', '9.0.2');

ALTER TABLE "ProfileMedias" ALTER COLUMN "ProfileId" DROP NOT NULL;

ALTER TABLE "ProfileExperienceMedias" ALTER COLUMN "ProfileExperienceId" DROP NOT NULL;

ALTER TABLE "PostMedias" ALTER COLUMN "PostId" DROP NOT NULL;

ALTER TABLE "JobPostingMedias" ALTER COLUMN "JobPostingId" DROP NOT NULL;

ALTER TABLE "CommentMedias" ALTER COLUMN "CommentId" DROP NOT NULL;

ALTER TABLE "ChatMedias" ALTER COLUMN "ChatId" DROP NOT NULL;
