...
(
    ...
    CONSTRAINT "PK_JobCategories" PRIMARY KEY
(
    "Id"
)
    );
...
(
    ...
    CONSTRAINT "PK_JobStatuses" PRIMARY KEY
(
    "Id"
)
    );
...
(
    ...
    CONSTRAINT "PK_MediaTypes" PRIMARY KEY
(
    "Id"
)
    );
...
(
    ...
    CONSTRAINT "FK_Media_MediaTypes_MediaTypeId" FOREIGN KEY
(
    "MediaTypeId"
) REFERENCES "MediaTypes"
(
    "Id"
)
                             ON DELETE CASCADE
...
(
    ...
    CONSTRAINT "FK_Profiles_Users_UserId" FOREIGN KEY
(
    "UserId"
) REFERENCES "Users"
(
...
(
    ...
    CONSTRAINT "PK_ChatMedias" PRIMARY KEY
(
    "Id"
),
    CONSTRAINT "FK_ChatMedias_Chats_ChatId" FOREIGN KEY
(
    "ChatId"
) REFERENCES "Chats"
(
    ...
    CONSTRAINT "FK_ChatMedias_Media_MediaId" FOREIGN KEY
(
    "MediaId"
) REFERENCES "Media"
(
...
(
    ...
    CONSTRAINT "FK_Areas_Profiles_ProfileId" FOREIGN KEY
(
    "ProfileId"
) REFERENCES "Profiles"
(
...
(
    ...
    CONSTRAINT "PK_ChatParticipants" PRIMARY KEY
(
    "ChatId",
    "ProfileId"
),
    CONSTRAINT "FK_ChatParticipants_Chats_ChatId" FOREIGN KEY
(
    "ChatId"
) REFERENCES "Chats"
(
    ...
    CONSTRAINT "FK_ChatParticipants_Profiles_ProfileId" FOREIGN KEY
(
    "ProfileId"
) REFERENCES "Profiles"
(
...
(
    ...
    CONSTRAINT "FK_Posts_Profiles_AuthorId" FOREIGN KEY
(
    "AuthorId"
) REFERENCES "Profiles"
(
...
(
    ...
    CONSTRAINT "PK_ProfileBadges" PRIMARY KEY
(
    "ProfileId",
    "BadgeId"
),
    CONSTRAINT "FK_ProfileBadges_Badges_BadgeId" FOREIGN KEY
(
    "BadgeId"
) REFERENCES "Badges"
(
    ...
    CONSTRAINT "FK_ProfileBadges_Profiles_ProfileId" FOREIGN KEY
(
    "ProfileId"
) REFERENCES "Profiles"
(
...
(
    ...
    CONSTRAINT "FK_ProfileExperiences_Profiles_ProfileId" FOREIGN KEY
(
    "ProfileId"
) REFERENCES "Profiles"
(
...
(
    ...
    CONSTRAINT "PK_ProfileMedias" PRIMARY KEY
(
    "Id"
),
    CONSTRAINT "FK_ProfileMedias_Media_MediaId" FOREIGN KEY
(
    "MediaId"
) REFERENCES "Media"
(
    ...
    CONSTRAINT "FK_ProfileMedias_Profiles_ProfileId" FOREIGN KEY
(
    "ProfileId"
) REFERENCES "Profiles"
(
...
(
    ...
    CONSTRAINT "PK_ProfileSkills" PRIMARY KEY
(
    "ProfileId",
    "SkillId"
),
    CONSTRAINT "FK_ProfileSkills_Profiles_ProfileId" FOREIGN KEY
(
    "ProfileId"
) REFERENCES "Profiles"
(
    ...
    CONSTRAINT "FK_ProfileSkills_Skills_SkillId" FOREIGN KEY
(
    "SkillId"
) REFERENCES "Skills"
(
...
(
    ...
    CONSTRAINT "PK_ProfileTags" PRIMARY KEY
(
    "ProfileId",
    "TagId"
),
    CONSTRAINT "FK_ProfileTags_Profiles_ProfileId" FOREIGN KEY
(
    "ProfileId"
) REFERENCES "Profiles"
(
    ...
    CONSTRAINT "FK_ProfileTags_Tags_TagId" FOREIGN KEY
(
    "TagId"
) REFERENCES "Tags"
(
...
(
    ...
    CONSTRAINT "PK_JobPostings" PRIMARY KEY
(
    "Id"
),
    CONSTRAINT "FK_JobPostings_Areas_AreaId" FOREIGN KEY
(
    "AreaId"
) REFERENCES "Areas"
(
    "Id"
                          ...
                          ON DELETE CASCADE,
    CONSTRAINT "FK_JobPostings_JobCategories_CategoryId" FOREIGN KEY
(
    "CategoryId"
) REFERENCES "JobCategories"
(
    "Id"
)
                          ON DELETE CASCADE,
    CONSTRAINT "FK_JobPostings_Profiles_AuthorId" FOREIGN KEY
(
    "AuthorId"
) REFERENCES "Profiles"
(
...
(
    ...
    CONSTRAINT "FK_Comments_Comments_ParentId" FOREIGN KEY
(
    "ParentId"
) REFERENCES "Comments"
(
    "Id"
                             ...
                             ON DELETE CASCADE,
    CONSTRAINT "FK_Comments_Posts_PostId" FOREIGN KEY
(
    "PostId"
) REFERENCES "Posts"
(
    ...
    CONSTRAINT "FK_Comments_Profiles_AuthorId" FOREIGN KEY
(
    "AuthorId"
) REFERENCES "Profiles"
(
...
(
    ...
    CONSTRAINT "PK_PostMedias" PRIMARY KEY
(
    "Id"
),
    CONSTRAINT "FK_PostMedias_Media_MediaId" FOREIGN KEY
(
    "MediaId"
) REFERENCES "Media"
(
    ...
    CONSTRAINT "FK_PostMedias_Posts_PostId" FOREIGN KEY
(
    "PostId"
) REFERENCES "Posts"
(
...
(
    ...
    CONSTRAINT "PK_PostTags" PRIMARY KEY
(
    "PostId",
    "TagId"
),
    CONSTRAINT "FK_PostTags_Posts_PostId" FOREIGN KEY
(
    "PostId"
) REFERENCES "Posts"
(
    ...
    CONSTRAINT "FK_PostTags_Tags_TagId" FOREIGN KEY
(
    "TagId"
) REFERENCES "Tags"
(
...
(
    ...
    CONSTRAINT "PK_PostVotes" PRIMARY KEY
(
    "Id"
),
    CONSTRAINT "FK_PostVotes_Posts_PostId" FOREIGN KEY
(
    "PostId"
) REFERENCES "Posts"
(
    "Id"
                          ...
                          ON DELETE CASCADE,
    CONSTRAINT "FK_PostVotes_Profiles_ProfileId" FOREIGN KEY
(
    "ProfileId"
) REFERENCES "Profiles"
(
...
(
    ...
    "ProfileExperienceId" character varying
(
    450
) NOT NULL,
    "MediaId" character varying
(
    ...
    CONSTRAINT "PK_ProfileExperienceMedias" PRIMARY KEY
(
    "Id"
),
    CONSTRAINT "FK_ProfileExperienceMedias_Media_MediaId" FOREIGN KEY
(
    "MediaId"
) REFERENCES "Media"
(
    ...
    CONSTRAINT "FK_ProfileExperienceMedias_ProfileExperiences_ProfileExperienc~" FOREIGN KEY
(
    "ProfileExperienceId"
) REFERENCES "ProfileExperiences"
(
    "Id"
)
  ON DELETE CASCADE
...
(
    ...
    "JobPostingId" character varying
(
    450
) NOT NULL,
    "MediaId" character varying
(
    ...
    CONSTRAINT "PK_JobPostingMedias" PRIMARY KEY
(
    "Id"
),
    CONSTRAINT "FK_JobPostingMedias_JobPostings_JobPostingId" FOREIGN KEY
(
    "JobPostingId"
) REFERENCES "JobPostings"
(
    "Id"
) ON DELETE CASCADE,
    CONSTRAINT "FK_JobPostingMedias_Media_MediaId" FOREIGN KEY
(
    "MediaId"
) REFERENCES "Media"
(
...
(
    ...
    CONSTRAINT "FK_Jobs_JobPostings_JobPostingId" FOREIGN KEY
(
    "JobPostingId"
) REFERENCES "JobPostings"
(
    ...
    CONSTRAINT "FK_Jobs_JobStatuses_JobStatusId" FOREIGN KEY
(
    "JobStatusId"
) REFERENCES "JobStatuses"
(
    "Id"
)
                        ON DELETE CASCADE,
    CONSTRAINT "FK_Jobs_Profiles_AuthorId" FOREIGN KEY
(
    "AuthorId"
) REFERENCES "Profiles"
(
    "Id"
                        ...
                        ON DELETE CASCADE,
    CONSTRAINT "FK_Jobs_Profiles_WorkerId" FOREIGN KEY
(
    "WorkerId"
) REFERENCES "Profiles"
(
...
(
    ...
    CONSTRAINT "PK_CommentMedias" PRIMARY KEY
(
    "Id"
),
    CONSTRAINT "FK_CommentMedias_Comments_CommentId" FOREIGN KEY
(
    "CommentId"
) REFERENCES "Comments"
(
    ...
    CONSTRAINT "FK_CommentMedias_Media_MediaId" FOREIGN KEY
(
    "MediaId"
) REFERENCES "Media"
(
...
(
    ...
    CONSTRAINT "PK_CommentVotes" PRIMARY KEY
(
    "Id"
),
    CONSTRAINT "FK_CommentVotes_Comments_CommentId" FOREIGN KEY
(
    "CommentId"
) REFERENCES "Comments"
(
    "Id"
                          ...
                          ON DELETE CASCADE,
    CONSTRAINT "FK_CommentVotes_Profiles_ProfileId" FOREIGN KEY
(
    "ProfileId"
) REFERENCES "Profiles"
(
...
(
    ...
    CONSTRAINT "PK_JobReviews" PRIMARY KEY
(
    "Id"
),
    CONSTRAINT "FK_JobReviews_Jobs_JobId" FOREIGN KEY
(
    "JobId"
) REFERENCES "Jobs"
(
    "Id"
                             ...
                             ON DELETE CASCADE,
    CONSTRAINT "FK_JobReviews_Profiles_CustomerId" FOREIGN KEY
(
    "CustomerId"
) REFERENCES "Profiles"
(
    "Id"
                             ...
                             ON DELETE CASCADE,
    CONSTRAINT "FK_JobReviews_Profiles_WorkerId" FOREIGN KEY
(
    "WorkerId"
) REFERENCES "Profiles"
(
