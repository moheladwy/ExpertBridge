...
/// <summary>
///     Entity Framework Core interceptor that implements the soft delete pattern for entities implementing
///     <see cref="ISoftDeletable" /> interface.
///     Intercepts delete operations and converts them to update operations that set IsDeleted flag and DeletedAt timestamp
...
///     - Query filtering: Works with global query filters in ExpertBridgeDbContext to automatically exclude soft-deleted
///     entities
...
public class SoftDeleteInterceptor : SaveChangesInterceptor
{
    ...
    /// <remarks>
    ///     This method processes all tracked entities marked for deletion, converts them to modified state, and applies soft
    ///     delete properties.
    ...
    /// <summary>
    ///     Intercepts asynchronous SaveChangesAsync operations to convert delete operations into soft deletes for entities
    ///     implementing <see cref="ISoftDeletable" />.
    ...
    /// <remarks>
    ///     This is the async version of the soft delete interceptor, typically used in web applications and async data access
    ///     patterns.
    ///     It processes all tracked entities marked for deletion, converts them to modified state, and applies soft delete
    ///     properties.
    ///     Non-soft-deletable entities are not affected and continue with normal hard delete behavior.
    /// </remarks>
