...
internal static class Firebase
{
    ...
    /// The client's base address is set to FirebaseSettings.AuthenticationTokenUri for making custom authentication requests.
    /// The typed client is injected into IFirebaseAuthService implementations for token refresh, user management, and other Firebase auth operations.
    /// </remarks>
