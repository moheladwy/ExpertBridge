...
/// <summary>
/// Provides extension methods for configuring Serilog structured logging with Seq integration in ASP.NET Core applications.
/// Replaces the default logging provider with Serilog for advanced logging features and centralized log aggregation.
/// </summary>
public static class Serilog
{
    /// <summary>
    /// Configures Serilog as the primary logging provider for the application with configuration-based setup and Seq endpoint integration.
