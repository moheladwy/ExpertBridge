...
/// <summary>
///     Provides extension methods for configuring OpenTelemetry observability with metrics, tracing, and logging in the
...
{
    /// <summary>
    ///     Configures comprehensive OpenTelemetry instrumentation including service discovery, logging, metrics, and
    ///     distributed tracing.
    ...
    ///     Also configures service discovery and optional OTLP exporter based on OTEL_EXPORTER_OTLP_ENDPOINT environment
    ///     variable.
    /// </remarks>
    ...
    /// <summary>
    ///     Conditionally adds OTLP (OpenTelemetry Protocol) exporter for sending telemetry to external observability
    ///     platforms.
    ...
    /// <returns>The builder instance for method chaining.</returns>
    /// <remarks>
    ///     The OTLP exporter is only enabled if the "OTEL_EXPORTER_OTLP_ENDPOINT" environment variable or configuration value
    ///     is set.
