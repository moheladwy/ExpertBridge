...
///     Defines the endpoint URL and model identifier for generating 1024-dimensional vector embeddings used in semantic
///     search.
/// </summary>
/// <remarks>
...
public sealed class EmbeddingServiceSettings
{
    ...
    /// <summary>
    ///     Gets or sets the Ollama model identifier used for embedding generation (e.g., "nomic-embed-text",
    ///     "mxbai-embed-large").
