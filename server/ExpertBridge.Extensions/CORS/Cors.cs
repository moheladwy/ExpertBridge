...
/// <summary>
///     Provides extension methods for configuring Cross-Origin Resource Sharing (CORS) policies in the ExpertBridge
///     application.
///     Defines multiple policies for different client access patterns including unrestricted API access and SignalR
...
public static class Cors
{
    ...
    ///     Configures two policies: AllowAll for general API access and SignalRClients for real-time WebSocket connections
    ///     with credentials.
    /// </summary>
