...
interface OrbProps {
	...
	/** Whether to rotate the orb on hover */
...
/**
 * Animated orb component using WebGL shaders.
 * Creates a colorful, animated orb effect with hover interactions.
 */
...
/**
 * Convert HSL values to RGB Vec3.
 */
...
/**
 * Convert a color string to Vec3 for WebGL uniforms.
